package com.example.tabdemo.app;
...
implements ActionBar.TabListener {
    ...
    private static City[] cities = {
        ...
        new City("Sydney", R.drawable.z4528296734_e8c4308dca_z,
                "Sydney is great."),
        new City("London", R.drawable.z7834697840_3e06380191_z,
                "London is great.")
    };
    ...
    protected void onCreate(Bundle in) {
        ...
        blurbView = (TextView) findViewById(R.id.blurbView);
